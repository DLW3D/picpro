...
# 图片文件存放路径
IMAGE_PATH = r'C:\dataset\faces'
# 图片文件和标签清单保存文件
IMAGE_LABEL_LIST = r'C:\Users\78753\.keras\data\2faces\5mdata96\images_&_labels.txt'
# TFR文件保存路径
TFR_PATH = r'C:\Users\78753\.keras\data\2faces\5mdata96'
